...
const TokenomicsSmartNavBar = () => {
    ...
    return(
        ...
        <DropDown animate={animate} transition={transition}>
            ...
            <Row>
            <LinkR to="/" style={{textDecoration: 'none'}}><Button whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}>HOME PAGE</Button></LinkR>
            </Row>
            <Row>
            <LinkR to="/aboutSmart" style={{textDecoration: 'none'}}><Button whileHover={{scale: 1.05}} whileTap={{scale: 0.95}} >ABOUT</Button></LinkR>
            </Row>
            <Row>
            <Row><LinkR to="/tokenomicsSmart" style={{textDecoration: 'none'}}><Button style={{border: '1px solid whitesmoke'}} >TOKENOMICS</Button></LinkR></Row>
            </Row>
            <Row>
...
export default TokenomicsSmartNavBar;