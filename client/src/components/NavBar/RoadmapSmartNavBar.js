...
const RoadmapSmartNavBar = () => {
    ...
    return(
        ...
        <DropDown animate={animate} transition={transition}>
            ...
            <Row>
            <LinkR to="/roadmapSmart" style={{textDecoration: 'none'}}><Button style={{border: '1px solid whitesmoke'}} >ROADMAP</Button></LinkR>
            </Row>
            <Row>
...
export default RoadmapSmartNavBar;