...
const AboutSmartNavBar = () => {
    ...
    return(
        ...
        <DropDown animate={animate} transition={transition}>
            ...
            <Row>
            <LinkR to="/aboutSmart" style={{textDecoration: 'none'}}><Button style={{border: '1px solid whitesmoke'}} >ABOUT</Button></LinkR>
            </Row>
            <Row>
...
export default AboutSmartNavBar;